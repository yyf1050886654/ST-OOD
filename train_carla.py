...
def init_param():
    ...
    # args.n_seqs = [16 for _ in range(len(frame_lens["train"]))]
    # args.n_seqs = min([frame_len - args.nd for frame_len in frame_lens["train"]])
    args.n_seq = 141
    args.n_seqs = [141 for _ in range(len(frame_lens["train"]))]
